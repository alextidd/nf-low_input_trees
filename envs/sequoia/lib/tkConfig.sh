...
# installed.
TK_PREFIX='/nfs/users/nfs_a/at31/miniforge3/envs/sequoia'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/nfs/users/nfs_a/at31/miniforge3/envs/sequoia'
...
# build directory.
TK_BUILD_LIB_SPEC='-L/nfs/users/nfs_a/at31/miniforge3/envs/sequoia/lib -ltk8.6'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/nfs/users/nfs_a/at31/miniforge3/envs/sequoia/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/nfs/users/nfs_a/at31/miniforge3/envs/sequoia/include'
...
# compiled.
TK_SRC_DIR='/nfs/users/nfs_a/at31/miniforge3/envs/sequoia/include'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/nfs/users/nfs_a/at31/miniforge3/envs/sequoia/lib -ltkstub8.6'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/nfs/users/nfs_a/at31/miniforge3/envs/sequoia/lib -ltkstub8.6'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/nfs/users/nfs_a/at31/miniforge3/envs/sequoia/lib/libtkstub8.6.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/nfs/users/nfs_a/at31/miniforge3/envs/sequoia/lib/libtkstub8.6.a'
